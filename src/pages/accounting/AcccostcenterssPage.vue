...
<div>
<q-space />
<q-table dense :rows-per-page-options="[10, 15, 20, 25, 50, 0]" v-model:pagination="pagination" title="Acccostcenters" :rows="dataAcccostcenterss" :filter="filter" :columns="columns" row-key="name" >
...
import { LISTSTATUSCOUNTING, ACTIVE, INACTIVE } from '../../constants/Constants'
export default defineComponent({
  name: 'AcccostcenterssPage',
  setup () {
    const path = '/acccostcenterss'
