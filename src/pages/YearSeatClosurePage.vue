...
export default defineComponent({
  ...
  setup () {
    ...
    const columns = ref([
      { name: 'code', align: 'center', label: 'Vigencia', field: 'code', sortable: true },
      { name: 'description', align: 'center', label: 'Estado asiento contable', field: 'description', sortable: true },
