...
<div>
<q-space />
<q-table dense :rows-per-page-options="[10, 15, 20, 25, 50, 0]" title="Hcclassanestrecord" :rows="dataHcclassanestrecords" :filter="filter" :columns="columns" row-key="name" >
...
export default defineComponent({
  ...
  setup () {
    ...
    const onDelete = (row) => {
      $q.dialog({
        title: 'Confirmación',
        message: '¿Está seguro que desea eliminar la clase de registro anestésico : ' + row.description + '?',
        ok: {
          label: 'Si',
          color: 'positive'
        },
