...
<div>
<q-space />
<q-table dense :rows-per-page-options="[10, 15, 20, 25, 50, 0]" v-model:pagination="pagination" title="Hcvacunclass" :rows="dataHcvacunclasss" :filter="filter" :columns="columns" row-key="name" >
...
export default defineComponent({
  ...
  setup () {
    ...
    const onDelete = (row) => {
      $q.dialog({
        title: 'Confirmación',
        message: '¿Está seguro que desea eliminar la clase de vacunas: ' + row.description + '?',
        ok: {
          label: 'Si',
          color: 'positive'
        },
