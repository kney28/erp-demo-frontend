...
export default defineComponent({
  ...
  setup () {
    ...
    const columns = ref([
      { name: 'date', align: 'center', label: 'Fecha cambio registro', field: 'date', sortable: true },
      { name: 'user', align: 'center', label: 'Usuario responsable', field: 'user', sortable: true },
      { name: 'username', align: 'center', label: 'Usuario modificado', field: 'username', sortable: true }
    ])
