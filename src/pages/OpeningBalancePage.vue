...
export default defineComponent({
  ...
  setup () {
    ...
    const columns = ref([
      { name: 'code', align: 'center', label: 'Cuenta contable', field: 'code', sortable: true },
      { name: 'description', align: 'center', label: 'Saldo inicial', field: 'description', sortable: true },
